...
Equipe: João Pedro Alves /nLaura Letícia /nMateus Tellez /nPaulo Victor
...
2 - Listar contatos: Exibe todos os contatos que foram salvos durante a execução.

3 - Buscar contato: Permite localizar um contato específico digitando o nome, telefone ou e-mail.
